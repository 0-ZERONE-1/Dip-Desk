          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {developers.map((dev, i) => (
              <motion.div
                ...
                className="group bg-white rounded-2xl shadow-card hover:shadow-card-hover border border-surface-200 overflow-hidden flex flex-col transition-all duration-300 max-w-sm mx-auto w-full h-full"
              >
                {/* Top Image - Exact 1:1 Aspect Ratio Fill */}
                ...
                {/* Bottom Information Panel - Compact Spacing with Bigger Icons */}
                <div className="px-5 pt-5 pb-2.5 flex flex-col text-center items-center flex-1">
                  ...
                  <div className="flex items-center gap-3.5 pt-2 border-t border-surface-100 w-full justify-center mt-auto flex-wrap">
                    ...
                    {dev.emailUrl && (
                      <a
                        href={dev.emailUrl.startsWith('mailto:') ? dev.emailUrl : `mailto:${dev.emailUrl}`}
