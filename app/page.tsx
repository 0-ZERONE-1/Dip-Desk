...
export default function HomePage() {
  return (
    <div className="bg-white min-h-screen flex flex-col relative overflow-hidden">
      {/* Background soft blue-purple ambient gradient glow — fixed so it covers the navbar spacer zone too */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[950px] h-[500px] bg-gradient-to-tr from-blue-400/15 via-indigo-500/15 to-purple-500/15 rounded-full blur-3xl" />
